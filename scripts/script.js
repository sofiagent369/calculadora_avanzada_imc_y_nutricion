document.addEventListener('DOMContentLoaded', () => {
    ...
    // Function to determine nutritional status based on BMI
    ...
    // Function to update the calculation history in localStorage and UI
    ...
    // Function to render the calculation history in the UI
    ...
    // Function to render the BMI history chart
    ...
    // Render history and chart on page load
    renderHistory();
    renderChart();
});